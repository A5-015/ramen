"""Star and Mesh Experiment Suite for Ramen

This script runs experiments to test for average packet success ratio and average election win
ratio between star and mesh networks by varying areas and number of nodes.
